...
import { HistorySnapshotState, LogExtractionConfigInput } from '../domain/saved_objects';
...
/**
 * Install / update body fields. Same as {@link LogExtractionConfigInput}: full config shape
 * without `timeout` (not user-settable via these APIs yet), all optional.
 */
export type LogExtractionInstallParams = LogExtractionConfigInput;
export const LogExtractionInstallParams = LogExtractionConfigInput;

export type LogExtractionUpdateParams = LogExtractionConfigInput;
export const LogExtractionUpdateParams = LogExtractionConfigInput;

export type LogExtractionBodyParams = LogExtractionConfigInput;
