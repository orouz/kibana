  ...
  const views: CustomAssetsAccordionProps['views'] = [
    {
      ...
      url: application.getUrlForApp('csp', { path: cloudPosturePages.dashboard.path }),
    ...
    },
    {
      ...
      url: application.getUrlForApp('csp', { path: cloudPosturePages.findings.path }),
      description: i18n.translate(
    ...
    },
    {
      ...
      url: application.getUrlForApp('csp', { path: cloudPosturePages.benchmarks.path }),
