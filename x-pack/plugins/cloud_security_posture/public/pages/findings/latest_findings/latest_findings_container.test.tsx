...
import { getEsRequest, getDefaultUrlQuery } from './latest_findings_config';
...
import { LatestFindingsContainer } from './latest_findings_container';
...
describe('<LatestFindingsContainer />', () => {
  it('data#search.search fn called with URL query', () => {
    const query = getDefaultUrlQuery({
      pageIndex: 0,
      filters: [],
